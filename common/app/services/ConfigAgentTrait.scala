...
/**
  ...
  *
  * It is the metadata overview for all fronts on theguardian.com. It describes
  * the fronts on website along with the collections they contain. The data is
  * pulled from a single file in S3 in the CMS Fronts AWS account.
  *
